<!-- main-sidebar -->
		...
		@if(auth()->user()->id != 1 )
         ...
         <div>
            ...
            <h2 style="padding-bottom:2%;padding-top:1%;font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;font-weight:bold;font-style:oblique;color:rgb(79, 158, 223);">{{$centre->nom}}</h2>
            @endif
            @endforeach
          </div>
		  &nbsp;
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround"  src="{{asset('imgs/'.auth()->user()->photo)}}"><span class="avatar-status profile-status bg-green"></span>
						...
						<div class="user-info">
							@if(auth()->user()->id != 1 )
							<h4 class="font-weight-semibold mt-3 mb-0">{{auth()->user()->nom}} {{auth()->user()->prenom}}</h4>
							<span class="mb-0 text-muted">{{auth()->user()->email}}</span>
							
							@endif
							@if(auth('admin')->check())
							<h4 class="font-weight-semibold mt-3 mb-0">Admin</h4>
							<span class="mb-0 text-muted">{{auth()->user()->nom}} {{auth()->user()->prenom}}</span>
				...
				<ul class="side-menu">
					<li class="slide">
					   ...
					   <button class="btn btn-primary btn-with-icon btn-block" style="width:50%;"> <i class="fa fa-home" aria-hidden="true" ></i></button></a>
						</div>
					</li>
				</ul>
				@endif
