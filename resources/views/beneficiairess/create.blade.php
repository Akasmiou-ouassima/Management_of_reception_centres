        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
                ...
                @endif
              <form action="{{ route('userss.storeBene') }}" method="post" enctype="multipart/form-data" >
                @csrf
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-6">
                      <div class="form-outline">
                        <input type="text" name="cin"   placeholder="" class="form-control typcn-calendar-outline form-control-lg fc-datepicker"  value="{{old('cin')}}" class="@error('cin') is-invalid @enderror">
                        @error('cin')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                          </div>
             ...
             <br>
              ...
              <br>         
                ...
                <div class="mt-2 pt-4" style="text-align:center;">
