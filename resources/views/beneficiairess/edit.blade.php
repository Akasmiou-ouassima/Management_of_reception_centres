        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 50px;">
            <div class="card-body p-4 p-md-5">
              ...
              @endif
              <form action="{{route('userss.updateBene',$beneficiaire->id)}}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      ...
                      <input type="text" name="nom" class="form-control form-control-lg" value="{{$beneficiaire->nom}}">
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <label class="form-label" ><h6 class="mb-2 pb-1">Prénom :</h6></label>
                      <input type="text"  name="prenom" class="form-control form-control-lg" value="{{$beneficiaire->prenom}}">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6 mb-6">
                      <div class="form-outline">
                        <input type="text" name="cin"  class="form-control  form-control-lg"  value="{{$beneficiaire->cin}}" >
              ...
              <br>
                <div class="row">
                    ...
                    <div class="form-outline">
                        ...
                        <input type="text" name="age" value="{{$beneficiaire->âge}}" class="form-control form-control-lg" >
                    </div>
                    </div>
                    ...
                    <div class="form-outline">
                        ...
                        <input type="date" name="date_naissance" value="{{$beneficiaire->date_de_naissance}}" class="form-control form-control-lg" >
                    </div>
                    </div>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="sexe" id="femaleGender"
                        value="Féminin" checked value="{{old('sexe')}}" class="@error('sexe') is-invalid @enderror"/>
                        @error('sexe')
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="sexe" id="maleGender"
                        value="Masculin" value="{{old('sexe')}}" class="@error('sexe') is-invalid @enderror"/>
                        @error('sexe')
                        <div class="alert alert-danger">{{ $message }}</div>
                       @enderror
                ...
                <div class="row">
                    ...
                    <div class="form-outline">
                        ...
                        <input type="text"  name="situation" value="{{$beneficiaire->situation_familiale}}" class="form-control form-control-lg">
                    </div>
                    </div>
                </div><br>
                    <div class="row">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="text"  name="etat" value="{{$beneficiaire->état_sanitaire}}" class="form-control form-control-lg">
                        </div>
                        </div>
                    </div><br>
                    <div class="row">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="date" name="date_entrée" value="{{$beneficiaire->date_entrée}}" class="form-control form-control-lg">
                        </div>
                        </div>
                        <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            <label class="form-label" ><h6 class="mb-2 pb-1">Date de sortie :</h6></label>
                            <input type="date" name="date_sortie" value="{{$beneficiaire->date_sortie}}"class="form-control form-control-lg">
                        </div>
                        </div>
                    </div><br>
                    <div class="row ">                 
                  ...
                  <select class="form-control form-control-lg selectpicker form-multi-select" value="{{$beneficiaire->services_bénéficier}}" data-coreui-search="true" name="service[]" multiple="multiple">        
                    ...
                    <div class="row">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="text"   name="remarques" value="{{$beneficiaire->remarques}}" class="form-control form-control-lg">
                        </div>
                        </div>
                    </div><br>
                            ...
                            <input type="file"   name="photo" value="{{$beneficiaire->photo}}" class="form-control form-control-lg">
                     <br>
