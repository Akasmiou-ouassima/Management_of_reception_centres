...
<div class="row row-xs wd-xl-70p">
    <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
        <form action="{{ route('admins.archiveBene',$id) }}" method="get">
            @csrf
                ...
                <div class="table-responsive">
                    <table class="table text-md-nowrap" id="example">
                        ...
                        <tbody>
                            ...
                            <td>
                            <a href="{{route('admins.editBene',$beneficiaire->id)}}"><div  class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0"><button class="btn btn-primary btn-with-icon btn-block" type="submit" ><i class="typcn typcn-edit"></i> </button></div>
                            </a><br>
                            <form action="{{ route('admins.SoftDeleteBene',$beneficiaire->id) }}" method="post">
                                @method('DELETE')
                                @csrf
