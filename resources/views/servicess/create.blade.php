        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
                ...
                @endif
                <form action="{{ route('userss.storeSer') }}" method="post">
                @csrf
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <input type="text" id="nom" name="nom" placeholder="Entrer nom" class="form-control form-control-lg" value="{{old('nom')}}"class="@error('nom') is-invalid @enderror" >
                    @error('nom')
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="form-check form-check-inline">
                          ...
                          <input class="form-check-input" type="radio" name="disponibilité" id="disponibilité"
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      ...
                      <input type="text" id="type" name="type" placeholder="Entrer type" value="{{old('type')}}" class="form-control form-control-lg" class="@error('type') is-invalid @enderror">
                      @error('type')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                  </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 mb-1">
                        <div class="form-outline">
                          <textarea type="text" id="description"  name="description" placeholder="Description"  class="form-control  form-control-lg " value="{{old('description')}}"class="@error('description') is-invalid @enderror">
                         </textarea>
                         @error('description')
                         <div class="alert alert-danger">{{ $message }}</div>
                     @enderror
                ...
                <div class="mt-4 pt-2" style="text-align:center;" >
                    <input class="btn btn-primary btn-lg" type="submit" id="form" value="Ajouter" />
...
$('#form').click(function(){
      var nom = $("#nom").val();
      var disponibilité = $("#disponibilité").val();
      var type = $("#type").val();
      var description = $("#description").val();

       
      if(nom == ''|| disponibilité=='' || type=='' ||description==''){
    
          swal({
              title: "L'insertion a bien été enregistré!",
